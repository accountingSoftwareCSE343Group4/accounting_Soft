 ...
 * @author Furkan
 */
public class GasolineDialog extends javax.swing.JDialog {
    ...
    public GasolineDialog(java.awt.Frame parent, boolean modal) {
        ...
        this.setTitle("Configure Gasoline");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GasolineDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GasolineDialog dialog = new GasolineDialog(new javax.swing.JFrame(), true);
